...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtFlareMaterial_Editor : SgtEditor
	{
		protected override void OnInspector()
		{
			...
			if (updateMaterial == true) Each(tgts, t => t.UpdateMaterial(), true);
			if (updateTexture  == true) Each(tgts, t => t.UpdateTexture (), true);
			if (applyMaterial  == true) Each(tgts, t => t.ApplyMaterial (), true);
		}
	}
}
#endif