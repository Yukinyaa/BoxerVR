...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtTerrainPlanet : SgtTerrain
	{
		...
		public int BakedDetailTilingA { set { bakedDetailTilingA = value; MarkAsDirty(); } get { return bakedDetailTilingA; } } [SerializeField] private int bakedDetailTilingA = 16;

		/// <summary>This allows you to bake detail texture tiling into the terrain mesh itself. This is superior to using the planet material's detail tiling setting, because it will avoid floating precision issues when extreme UV tiling is used.</summary>
		public int BakedDetailTilingB { set { bakedDetailTilingB = value; MarkAsDirty(); } get { return bakedDetailTilingB; } } [SerializeField] private int bakedDetailTilingB = 1000;

		/// <summary>This allows you to bake detail texture tiling into the terrain mesh itself. This is superior to using the planet material's detail tiling setting, because it will avoid floating precision issues when extreme UV tiling is used.</summary>
		public int BakedDetailTilingC { set { bakedDetailTilingC = value; MarkAsDirty(); } get { return bakedDetailTilingC; } } [SerializeField] private int bakedDetailTilingC = 100000;
